...
<tr style="height: 18px;">
<td style="width: 50%; height: 18px; text-align: center;"><strong>City</strong></td>
<td style="width: 50%; height: 18px; text-align: center;">{{$data["city"] }}</td>
</tr>
<tr style="height: 18px;">
...
<td style="width: 50%; height: 18px; text-align: center;">{{$data["message"] }}</td>
</tr>
