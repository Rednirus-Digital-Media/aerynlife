...
<div class="breadcrumb__thumb" data-background="assets/imgs/breadcrumhh.png" style="background-image: url(&quot;assets/imgs/breadcrumhh.png&quot;);">&nbsp;</div>
...
<h2 class="breadcrumb__title">{{ $blog->name }}</h2>
